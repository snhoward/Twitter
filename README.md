...
**Thweeter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
< https://github.com/snhoward/Twitter/blob/master/TwitterGif.gif />
...
* Figuring out how to compose the tweet and have it show up on the timeline
* Switching from an action bar to a toolbar
* Creating a floating action tab
